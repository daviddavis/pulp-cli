...
from pulpcore.cli.ansible.context import (
    PulpAnsibleContentContext,
    PulpAnsibleRemoteContext,
...
def create(
    ...
    if remote:
        remote_href: str = PulpAnsibleRemoteContext(pulp_ctx).find(name=remote)["pulp_href"]
...
def add(
    ...
    content_href = PulpAnsibleContentContext(pulp_ctx).find(
